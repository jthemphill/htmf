...
export default React.memo(function (props) {
    ...
    for (let r = 0; r < NUM_ROWS; ++r) {
        ...
        for (let c = 0; c < row_len; ++c) {
            ...
            hexes.push(React.createElement(Hex, { key: key, _key: key, onClick: props.handleCellClick, fish: fish, cx: x, cy: y, sideLength: side_length, highlighted: is_highlighted, possible: possible, player: players.get(key), claimed: claimed.has(key) }));
        }
    }
