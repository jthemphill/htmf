...
import "./index.css";
export default function Penguin({ size, player }) {
    let playerClass = "";
    ...
    return (React.createElement("g", { className: `penguin ${playerClass}`, transform: `scale(${scale.toString()}),translate(${translateX.toString()},${translateY.toString()})` },
        React.createElement("g", { transform: "matrix(2.0165499,0,0,2.0165499,-378.20444,-374.28247)" },
            ...
            React.createElement("path", { transform: "matrix(0.59003831,0,0,0.59003831,186.08628,108.73722)", d: "m 446.48743,416.47116 c 0,72.80489 -58.79389,131.82491 -131.31983,131.82491 -72.52593,0 -131.31982,-59.02002 -131.31982,-131.82491 0,-72.80488 58.79389,-131.8249 131.31982,-131.8249 72.52594,0 131.31983,59.02002 131.31983,131.8249 z", className: "penguin" }),
            React.createElement("path", { transform: "translate(59.910095,0)", d: "m 361.63462,289.69702 c 0,27.3367 -22.16077,49.49748 -49.49747,49.49748 -27.3367,0 -49.49748,-22.16078 -49.49748,-49.49748 0,-27.3367 22.16078,-49.49747 49.49748,-49.49747 27.3367,0 49.49747,22.16077 49.49747,49.49747 z", className: "penguin" }),
            ...
            React.createElement("path", { d: "M 332.14074,297.03867 247.29889,260.5461 c 10.94712,32.37883 32.49618,64.01962 75.63693,75.93783 z", className: "penguin" }),
            React.createElement("path", { className: "penguin", d: "M 411.95375,297.03867 496.7956,260.5461 c -10.94712,32.37883 -32.49618,64.01962 -75.63693,75.93783 z" }))));
}
